...
export default function NavBarLayout() {
  return (
    <Navigation>
      <img src="/pink-octopus.png" alt="pink octopus" className="logo" />
      ...
      <nav>
        <ul>
          <li><a href="#mewni"> mewni </a> </li>
          <li><a href="#aboutme"> about me </a> </li>
          <li><a href="#spells"> book of spells </a> </li>
          <li><a href="#blog"> blog </a> </li>
          <li><a href="#merchandise"> merchandise </a>  </li>
          <li><a href="#subscribe" className="btn"> get my updates </a> </li>
        </ul>
      </nav>
    </Navigation>
  );
